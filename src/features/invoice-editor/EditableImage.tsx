...
import { Upload, Crop as CropIcon, Image as ImageIcon } from "lucide-react";
...
export const EditableImage = ({
  ...
  return (
    <ContentEditable
      ...
      showLock={false} // Images generally don't have font styling or standard locking in this context
      onClear={handleClear}
      popoverWidth="w-72"
